    ...
    <body>		
		...
		<div id="wrapper" class="container">
			...
			<img class="pageBanner" src="themes/images/pageBanner.png" alt="New products" >
				<h4><span>Liên lạc với chúng tôi</span></h4>
			</section>
				...
				<div class="row">				
					<div class="span5">
						<div>
							...
							<p><strong>Số điện thoại:</strong>&nbsp;(123) 456-7890<br>
							<strong>Fax:</strong>&nbsp;+04 (123) 456-7890<br>
							<strong>Email:</strong>&nbsp;<a href="#">vietcuong_it@yahoo.com</a>								
							</p>
							<br/>
							<h5>CHI NHÁNH THỨ HAI Ở VIỆT NAM</h5>
							<p><strong>Số điện thoại:</strong>&nbsp;(113) 023-1125<br>
						...
						<form method="post" action="#">
							<fieldset>
								<div class="clearfix">
									...
									<div class="input">
										<input tabindex="1" size="18" id="name" name="name" type="text" value="" class="input-xlarge" placeholder="Tên">
									</div>
								</div>
								...
								<div class="clearfix">
									...
									<div class="input">
										<textarea tabindex="3" class="input-xlarge" id="message" name="body" rows="7" placeholder="Tin nhắn"></textarea>
									</div>
								</div>
